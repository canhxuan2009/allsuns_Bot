...
1. **SCAM** — Hình ảnh có nội dung lừa đảo, bao gồm:
   - Quảng cáo crypto/tiền điện tử giả mạo, crypto giveaway, airdrop scam
   - Giả mạo MrBeast, YouTuber nổi tiếng để lừa đảo
   - Quảng cáo chứng khoán, forex, đầu tư lừa đảo
   - Quảng cáo tặng tiền, gift card miễn phí
   - Discord Nitro giả mạo, Steam gift giả mạo
   - Bất kỳ hình thức lừa đảo trực tuyến nào khác
...
3. **SAFE**
   - Hình ảnh bình thường, không vi phạm bất kỳ quy tắc nào ở trên.
   - Bất kể ảnh gì trong game Minecraft, tự động gắn nhãn SAFE.
   - Các giao diện khác trong các website/app không liên quan và không chứa nội dung lừa đảo, cũng được gắn nhãn SAFE.
